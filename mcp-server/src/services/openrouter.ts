...
let lastUsedContext: Partial<IntentResponse> = {};
...
function resolveProjectId(projectName: string): string {
...
export async function interpretPrompt(message: string): Promise<IntentResponse & { projectId: string; stats?: any; message: string }> {
